...
public class TSBHashTableDA<K,V> extends AbstractMap<K,V> implements Map<K,V>, Cloneable, Serializable
{
    ...
    //abierto=0 significa que la casilla está vacía
    public static final int OPEN = 0;
    //cerrado=1 significa que la casilla está ocupada
    public static final int CLOSED = 1;
    //eliminado=2 significa que la casilla estaba ocupada y ahora se elimino
    ...
    public V get(Object key)
    {
        ...
        // tipo de key debe ser compatible con la tabla.
     ...
     * @return true si la Key es compatible con la clase K de la tabla.
     */
    private boolean isCompatibleKey(Object key) {
        try {
            K k = (K) key;
            return true;
    ...
    {
        Set<? extends Map.Entry<? extends K, ? extends V>> se = m.entrySet();
        Iterator<? extends Map.Entry<? extends K, ? extends V>> it = se.iterator();
        while(it.hasNext())
        {
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> 
    {
        ...
        private class EntrySetIterator implements Iterator<Map.Entry<K, V>>
        {
            ...
            // el valor que debería tener el modCount de la tabla completa...
            private int expected_modCount;
            private int actual; // dirección del nodo que toca procesar.
            private int previo; // dirección del nodo anterior al que toca procesar.
            /*
             * Crea un iterador comenzando en la primera lista. Activa el 
             * mecanismo fail-fast.
             */
